...
Config.Collectables = {
    ...
    SpaceshipParts = {
        ...
        Items = {
            ...
            { ID=29, Pos = vector3(816,1851,121.00) },
            { ID=30, Pos = vector3(-1944,1941,164.27) },
            { ID=31, Pos = vector3(-1437,2129,27.5) },
    ...
    SubParts = {
        ...
        Items = {
            ...
            { ID=16, Pos = vector3(909.48,-3470.99,-17.60), Fixed = true },
